...
class placeControllers {
  ...
  getPlaces = (req, res) => {
    let sql =
      "SELECT * FROM city LEFT JOIN province ON province.province_id = city.province_id";
  ...
  //2.Traer la informacion tanto de ciudades como provincias de un usuario concreto
