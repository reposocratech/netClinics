...
export const FormLogin = ({handleChange, onSubmit, login, navigate, errorPassword, errorEmail, errorMessage}) => {
  return (
            ...
            <Col className='d-flex align-items-center justify-content-center'>
                <div className='whiteBoxFormLogin d-flex flex-column'> 
                    ...
                    <div className='d-flex flex-column'>
                        ...
                        {errorPassword && <h5 className='text-center text-danger pb-2'>{errorPassword}</h5>}
                        {errorMessage && <h5 className='text-center text-danger pb-2'>{errorMessage}</h5>}
