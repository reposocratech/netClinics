...
export const FormRegisterMedic = ({ registerMedic, message, listProvinces, listCities, navigate, handleChange, handleFiles, onSubmit, getCity, handleCities, listSpecialities}) => {
  return (
      ...
      <Row>
        <Col className='d-flex flex-column align-items-center justify-content-center'>
          <div className='whiteBoxFormRegister'>
            ...
            <InputGroup className='mb-3'>
              <InputGroup.Text id="basic-addon1" className='inputRegister'><i className="fa-solid fa-id-card-clip"></i></InputGroup.Text>
              <Form.Control
            ...
            <InputGroup className='mb-3'>
              ...
              <Form.Select className='selectMedic' name='province'
            ...
            <InputGroup className='mb-3'>
              <div className='d-flex w-100'>
              <InputGroup.Text id="basic-addon1" className='inputRegister iconSelect'><i className="fa-solid fa-city"></i></InputGroup.Text>
              <Form.Select className='selectMedic' name='cities'
            ...
            <InputGroup className='mb-3'>
              ...
              <Form.Select className='selectMedic' name='speciality_id' onChange={handleChange}>
            ...
            <InputGroup className='mb-3 d-flex flex-columns text-center align-items-center justify-content-center'>
              <div className='text-center inputFile'>
                <input className='mb-2' type='file' name='file' multiple={true} onChange={handleFiles}/>
