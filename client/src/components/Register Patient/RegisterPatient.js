...
export const RegisterPatient = ({showRegisterPatient, setShowRegisterPatient, showRegisterMedic, setShowRegisterMedic}) => {
  ...
  return (
    <div className='bgColor d-flex flex-column'>
        <button className='borderButton' onClick={showFormMedic}>
